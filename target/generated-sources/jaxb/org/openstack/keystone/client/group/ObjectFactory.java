 ...
 * generated in the org.openstack.keystone.client.group package. 
...
public class ObjectFactory {
    ...
    private final static QName _Group_QNAME = new QName("http://docs.rackspace.com/identity/api/ext/RAX-KSGRP/v1.0", "group");
    private final static QName _Groups_QNAME = new QName("http://docs.rackspace.com/identity/api/ext/RAX-KSGRP/v1.0", "groups");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.openstack.keystone.client.group
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://docs.rackspace.com/identity/api/ext/RAX-KSGRP/v1.0", name = "group")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://docs.rackspace.com/identity/api/ext/RAX-KSGRP/v1.0", name = "groups")
    public JAXBElement<GroupList> createGroups(GroupList value) {
        return new JAXBElement<GroupList>(_Groups_QNAME, GroupList.class, null, value);
    }
