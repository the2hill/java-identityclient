package org.openstack.keystone.client.fault;

import javax.xml.bind.annotation.XmlAttribute;
import javax.xml.bind.annotation.XmlType;

@XmlType(namespace = "http://docs.rackspacecloud.com/auth/api/v1.1")
public class KeystoneFault extends Exception {
    public String message;
    public String details;
    public int code;

    public KeystoneFault() {
    }
     ...
     * @param code
     */
    public KeystoneFault(String message, String details, int code) {
