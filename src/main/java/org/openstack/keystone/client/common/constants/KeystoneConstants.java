package org.openstack.keystone.client.common.constants;
...
public class KeystoneConstants {
    ...
    static {
        ...
        {
            logger.warn("Could not load MIME.types all refrences to KeystoneConstants.MIMETYPES will return null.", err);
        }
    }
